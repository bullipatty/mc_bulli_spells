...
public class SpellsMod {
	...
	private static HashSet<String> spells;
	
	public SpellsMod(JavaPlugin plugin) {
		spells = new HashSet<String>();
		spells.add(ChasingProjectile.name);
		plugin.getServer().getPluginManager().registerEvents(new SpellsModListener(plugin), plugin);
		
		ChasingProjectile.load(plugin);
	}
	
	public class SpellsModListener implements Listener {
		
	//	private JavaPlugin _plugin;
		
		public SpellsModListener(JavaPlugin plugin) {
	//		_plugin = plugin;
		}
