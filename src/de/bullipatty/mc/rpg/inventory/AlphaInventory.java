...
public class AlphaInventory implements Inventory {
	
	private Inventory _inventory = null;
	
	public AlphaInventory(InventoryHolder owner, int size, String name) {
		_inventory = Bukkit.createInventory(owner, size, name);
	}
	
	public AlphaInventory(InventoryHolder owner, InventoryType type) {
		_inventory = Bukkit.createInventory(owner, type);
	}
